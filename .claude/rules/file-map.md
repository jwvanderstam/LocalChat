...
| `scripts/scaleway/landing/index.html` | The public landing page served at `atospoc.solbyco.nl` — the deployment's instructions and report. Version-controlled because the LocalChat stack is ephemeral and this host is not; carries no ids, addresses or keys, since it is served publicly (§13 of `DEPLOYMENT_SCALEWAY.md`) |
